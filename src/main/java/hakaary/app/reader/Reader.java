...
public class Reader {
    ...
    public static HashMap<Integer, ArrayList<String>> getChaptersPages(File dir) {
    ...
    private static void addChapterImage(File dir, File file) {
        String[] dirSplit = dir.getAbsolutePath().split(Pattern.quote(File.separator));
        int dirSplitNumber;
        try {
        ...
        ArrayList<String> chapterImagesList = new ArrayList<String>();
